...
function fnLoadGridAgeRange() {
    ...
    $("#jqgAgeRange").jqGrid({
        ...
        colModel: [
            ...
            { name: "RangeFromPeriod", width:30, editable: false, hidden: false, align: 'left', resizable: true, formatter: 'select', editoptions: { value: "Y: Year;D: Day" } },
            { name: "AgeRangeTo", width: 30, editable: false, hidden: false, align: 'left', resizable: true },
            { name: "RangeToPeriod", width: 30, editable: false, hidden: false, align: 'left', resizable: true, formatter: 'select', editoptions: { value: "Y: Year;D: Day" } },
