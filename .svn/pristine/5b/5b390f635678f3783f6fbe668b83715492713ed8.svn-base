...
function fnAddSMSRecipient() {
    ...
    if (IsStringNullorEmpty($("#cboFormId").val())) {
        fnAlert("w", "ESE_05_00", "UI0106", errorMsg.FormName_E7);
        return;
    }
...
function fnSaveSMSRecipient() {
    ...
    if (IsStringNullorEmpty($("#cboFormId").val())) {
        fnAlert("w", "ESE_05_00", "UI0106", errorMsg.FormName_E9);
        return false;
    }

    if (IsStringNullorEmpty($("#cboSMSDescription").val())) {
        fnAlert("w", "ESE_05_00", "UI0106", errorMsg.SMSDesc_E10);
        return false;
    }
    if (IsStringNullorEmpty($("#txtRecipientName").val())) {
        fnAlert("w", "ESE_05_00", "UI0106", errorMsg.RecipientName_E11);
        return false;
    }
    else if (IsStringNullorEmpty($("#txtMobileNumber").val())) {
        fnAlert("w", "ESE_05_00", "UI0106", errorMsg.MobileNumber_E12);
        return false;
    }
    else {
