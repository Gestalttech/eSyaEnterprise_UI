...
function fnLoadLanguageCultureGrid() {
    ...
    $("#jqgLanguageCulture").jqGrid({
        ...
        mtype: 'POST',
        colNames: [localization.ID, localization.ResourceName, localization.Key, localization.Value, localization.Culture, localization.CultureValue],
        colModel: [
        ...
        loadonce: true,
        cellEdit: true,
        caption: localization.LanguageCulture,
        editurl: 'url',
...
function fnSaveResourceCulture() {
    ...
    if (resourcekey === '0') {
        fnAlert("w", "ELE_04_00", "UI0086", errorMsg.ResourceKey_E6);
        return;
    }
    if (IsStringNullorEmpty($("#txtValue").val())) {
        fnAlert("w", "ELE_04_00", "UI0087", errorMsg.Key_E7);
        return;
    }
    if (IsStringNullorEmpty($("#txtCultureValue").val())) {
        fnAlert("w", "ELE_04_00", "UI0088", errorMsg.Value_E8);
        return;
    }
