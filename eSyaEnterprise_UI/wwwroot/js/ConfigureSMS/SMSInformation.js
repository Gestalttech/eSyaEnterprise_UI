...
function fnGridLoadSMSEmptyParameter() {
    ...
    $("#jqgSMSParameter").jqGrid({
        ...
        colModel: [
            ...
            { name: "IsVariable", width: 35, editable: true, align: 'center', resizable: false, edittype: "checkbox", formatter: 'checkbox', editoptions: { value: "true:false" }, formatoptions: { disabled: false } },
...
function fnAddSMSInformation() {
    if ($("#cboFormId").val() === "" || $("#cboFormId").val() === '' || $("#cboFormId").val() === '0') {
        fnAlert("w", "", "UI0108", errorMsg.FormSelect_E10);
        return;
    }
