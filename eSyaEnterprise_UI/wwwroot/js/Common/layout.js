...
$(document).ready(function () {
    ...
    $("#btn-menuBar").click(function (e) {
        ...
        $("#jquery-accordion-menu ul li a").each(function () {
            ...
            if ($(this).attr("href") == url) {
                ...
                $(this).parent().parent().prev().find('svg').attr('data-icon', 'caret-down');
                $(this).parent().parent().parent().parent().prev().find('svg').attr('data-icon', 'circle-minus');
                ...
                // $("[data-node=first]").next().css('display', 'none');
            }
    ...
    $("#jquery-accordion-menu").css({
        'height': $(window).innerHeight() - $('section.header').outerHeight() - $(".banner").outerHeight(),
        'top': $('section.header').outerHeight() + $(".banner").outerHeight() + 'px'
    });
    ...
    $("body").click(function (e) {
        ...
        $("[data-node=second] li a").find('svg').attr('data-icon', 'caret-right');
        $("[data-node=second] li a").next().css('display', 'none');
        $("[data-node=first]").find('svg').attr('data-icon', 'circle-plus');
        $("[data-node=first]").next().css('display', 'none');
    });
...
function fnModalPopupScrollFull() {
    var winH = $(window).height();
    var winW = $(window).width();
    var modalHeaderH = $('.modal-header').outerHeight(true);
    var modalFooterH = $('.modal-footer').outerHeight(true);
    var topSpace = $('section.header').outerHeight(true) + $('.banner').outerHeight(true);
    $(".modal-body").css({ 'max-height': 'unset', 'overflow-y': 'auto', 'overflow-x': 'hidden' });
    $('.modal').css('top', '0px');
}
...
function fnTreeSize(id) {
    ...
    var _treeID = $(id);
    var offset = _treeID.offset();
    var _treeIDTop = offset.top;
    ...
    if (_winWidth < 1025) {
        ...
        $(id).css({
            'height': $(window).innerHeight() - _treeIDTop - 15,
            'overflow-y': 'auto',
            'overflow-x': 'hidden'
        });
    }
}
function fnTreeSizePopup(id) {
    ...
    if (_winWidth < 1025) {
        ...
        $(id).css({
            'height': $(window).innerHeight() - _treeIDTop - 15 - 116,
            'overflow-y': 'auto',
            'overflow-x': 'hidden'
        });
    }
...
// function fnModuleClick(e) {

//     if ($(e.target).find('svg ').attr('data-icon') == 'circle-plus') {
//         $("[data-node=first]").find('svg').attr('data-icon', 'circle-plus');
//         $(e.target).find('svg ').attr('data-icon','circle-minus')
//     }
//     else{
//         $(e.target).find('svg ').attr('data-icon', 'circle-plus');
//     }
