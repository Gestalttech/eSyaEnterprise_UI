...
function fnLoadGridPortfolios() {
    ...
    $("#jqgPortfolio").jqGrid({
        url: getBaseURL() + '/Stores/GetAllPortfolios',
        datatype: 'json',
        mtype: 'POST',
...
function fnSavePortfolio() {
    ...
    $.ajax({
        url: getBaseURL() + '/Stores/InsertOrUpdateIntoPortfolio',
        type: 'POST',
        datatype: 'json',
...
function fnDeletePortfolio() {
    ...
    $.ajax({
        url: getBaseURL() + '/Stores/ActiveOrDeActivePortfolio?status=' + a_status + '&PortfolioId=' + $("#txtPortfolioId").val(),
        type: 'POST',
        success: function (response) {
            if (response.Status) {
                fnAlert("s", "", response.StatusCode, response.Message);
