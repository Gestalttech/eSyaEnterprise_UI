...
function fnGridLoadCalendarDefinition() {
    ...
    $("#jqgCalendarDefinition").jqGrid({
        ...
        colModel: [
            ...
            { name: "Status", width: 35, editable: true, align: 'center', edittype: "checkbox", formatter: 'checkbox', editoptions: { value: "true:false" }, formatoptions: { disabled: false } },
        ],
        rowNum: 10,
...
function fnValidateCalendarDefinition() {
    ...
    if (IsStringNullorEmpty($("#txtfinancialyear").val())) {
        fnAlert("w", "EPS_21_00", "UI0068", errorMsg.FinancialYear_E7);
        return false;
    }
