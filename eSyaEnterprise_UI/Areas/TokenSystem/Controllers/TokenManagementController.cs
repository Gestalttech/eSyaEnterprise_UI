...
namespace eSyaEnterprise_UI.Areas.TokenSystem.Controllers
{
    ...
    public class TokenManagementController : Controller
    {
        ...
        public TokenManagementController(IeSyaTokenSystemAPIServices TokenSystemAPIServices, ILogger<TokenManagementController> logger)
        {
        ...
        public async Task<JsonResult> GetTokenDetailByTokenType(string tokenType)
        {
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.GetAsync<List<DO_Token>>("TokenManagement/GetTokenDetailByTokenType" + parameter);
                if (serviceResponse.Status)
        ...
        public async Task<JsonResult> GetTokenTypeByCounter(string counterNumber)
        {
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.GetAsync<List<DO_TokenConfiguration>>("TokenManagement/GetTokenTypeByCounter" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateCallingToken(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateCallingToken", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateTokenToHold(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateTokenToHold", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateTokenToRelease(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateTokenToRelease", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateTokenStatusToCompleted(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateTokenStatusToCompleted", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateToCallingNextToken(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateToCallingNextToken", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateCallingConfirmation(DO_Token obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaTokenSystemAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("TokenManagement/UpdateCallingConfirmation", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
