...
namespace eSyaEnterprise_UI.Areas.Vendor.Controllers
{
    ...
    public class ApproveController : Controller
    {
        ...
        public ApproveController(IeSyaVendorAPIServices eSyaVendorAPIServices, IeSyaProductSetupAPIServices eSyaProductSetupAPIServices, ILogger<ApproveController> logger)
        {
