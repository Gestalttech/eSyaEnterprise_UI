...
namespace eSyaEnterprise_UI.Areas.Admin.Controllers
{
    ...
    public class RulesController : Controller
    {
        ...
        public IActionResult EAD_04_00()
        {
            return View();
        }
        ...
        public async Task<JsonResult> GetInventoryRules()
        {
            try
            {
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<List<DO_InventoryRules>>("InventoryRules/GetInventoryRules");
        ...
        public async Task<JsonResult> InsertOrUpdateInventoryRules(DO_InventoryRules rule)
        {
            ...
            try
            {
                ...
                if (rule.Isadd == 1)
                {
                    ...
                    var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("InventoryRules/InsertInventoryRule", rule);
                    if (serviceResponse.Status)
                        return Json(serviceResponse.Data);
                    else
                ...
                {
                    var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("InventoryRules/UpdateInventoryRule", rule);
                    if (serviceResponse.Status)
                        return Json(serviceResponse.Data);
                    else
                        return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> ActiveOrDeActiveInventoryRules(bool status, string InventoryId)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("InventoryRules/ActiveOrDeActiveInventoryRules" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> GetUnitofMeasurements()
        {
            try
            {
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<List<DO_UnitofMeasure>>("InventoryRules/GetUnitofMeasurements");
                if (serviceResponse.Status)
                {
        ...
        public async Task<JsonResult> InsertOrUpdateUnitofMeasurement(DO_UnitofMeasure uoms)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("InventoryRules/InsertOrUpdateUnitofMeasurement", uoms);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> GetUOMPDescriptionbyUOMP(string uomp)
        {
            try
            {
                ...
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<DO_UnitofMeasure>("InventoryRules/GetUOMPDescriptionbyUOMP" + parameter);
        ...
        public async Task<JsonResult> GetUOMSDescriptionbyUOMS(string uoms)
        {
            try
            {
                ...
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<DO_UnitofMeasure>("InventoryRules/GetUOMSDescriptionbyUOMS" + parameter);
        ...
        public async Task<JsonResult> ActiveOrDeActiveUnitofMeasure(bool status, int unitId)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaAdminAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("InventoryRules/ActiveOrDeActiveUnitofMeasure" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
