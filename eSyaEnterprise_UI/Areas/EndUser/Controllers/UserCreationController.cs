...
namespace eSyaEnterprise_UI.Areas.EndUser.Controllers
{
    ...
    public class UserCreationController : Controller
    {
        ...
        public async Task<JsonResult> GetUserBusinessLocation(short UserID)
        {
            try
            {
                var serviceResponse = await _eSyaEndUserAPIServices.HttpClientServices.GetAsync<List<DO_UserBusinessLink>>("UserCreation/GetUserBusinessLocation?UserID=" + UserID + "&CodeTypeUG=" + CodeTypeValues.UserGroup + "&CodeTypeUT=" + CodeTypeValues.UserType);
